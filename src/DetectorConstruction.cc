...
// //----------------------------------------------------------
  ...
  G4LogicalVolume* Magnet_2 = new G4LogicalVolume(MagnetBox, Fe, "Magnet_2");
  new G4PVPlacement(0,
  ...
  //-------------------------------------------------------------
  auto cylinder = new G4LogicalVolume( mesh1->GetSolid("Cylinder")
                                         , Vacuum
                                         , "logic"
                                         , 0, 0, 0
        );
  ...
  new G4PVPlacement( rot
                         , G4ThreeVector(length_vac/2 + 2*mm, 0, 0)
                         , cylinder 
                         , "Staff"
                         , Boxvac1
  ...
  new G4PVPlacement(0,
                    ...
                    2,
                    fCheckOverlaps);
  auto tubem = new G4LogicalVolume( mesh1->GetSolid("Tube")
                                         , Fe
                                         , "logic"
                                         , 0, 0, 0
        );
